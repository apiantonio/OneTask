    ...
    if (progetto.isEmpty) {
      ...
      return Progetto(
        ...
        completato: progetto[0]['completato'] == null
            ...
            /// se completato è null allora il valore è null
            : (progetto[0]['completato'] as int) == 1,

        /// 'completato' se non è null allora deve essere un booleano ma nella tabella è un integer
